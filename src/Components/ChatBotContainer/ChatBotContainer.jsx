...
//     `if the question is related to ${questionDomain.join(', ')} - answer it from: ${answerDomain.join(', ')} where question is: ${message}, else say: Please try another Question`;
...
//         //TODO: Call API fro chatbot //C:\Users\admin\Desktop\aiprojects\ai-tools\src\pages\api\chatbot.js
//         fetch('/api/chatbot', {
//             method: 'POST',
//             body: JSON.stringify({
//                 message: {
